...
MODERATOR_ROLE_ID = int(os.getenv("MODERATOR_ROLE_ID", "1353068159346671707")) # Existing MODERATOR_ROLE_ID
...
MODERATOR_ROLE_IDS = {MODERATOR_ROLE_ID, MODERATOR_ROLE_ID_1, MODERATOR_ROLE_ID_2}
