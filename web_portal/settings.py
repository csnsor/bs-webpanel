...
# Role and Channel IDs for Appeal Workflows
# Discord Appeals (should not be touched)
DISCORD_MODERATOR_ROLE_ID = int(os.getenv("DISCORD_MODERATOR_ROLE_ID", "1353068159346671707"))
APPEAL_CHANNEL_ID = int(os.getenv("APPEAL_CHANNEL_ID", "1449872679698960517"))

# Roblox Appeals (Two-Step Moderation)
ROBLOX_INITIAL_MODERATOR_ROLE_ID = int(os.getenv("ROBLOX_INITIAL_MODERATOR_ROLE_ID", "1393602263146172559"))
ROBLOX_ELEVATED_MODERATOR_ROLE_ID = int(os.getenv("ROBLOX_ELEVATED_MODERATOR_ROLE_ID", "1378115294731440328"))
ROBLOX_APPEAL_CHANNEL_ID = int(os.getenv("ROBLOX_APPEAL_CHANNEL_ID", "1437227634642780335")) # Step 1 channel
ROBLOX_UNBAN_REQUEST_CHANNEL_ID = int(os.getenv("ROBLOX_UNBAN_REQUEST_CHANNEL_ID", "1345697823768707072")) # Step 2 channel
...
ROBLOX_APPEAL_CHANNEL_ID = int(os.getenv("ROBLOX_APPEAL_CHANNEL_ID", "1437227634642780335"))
ROBLOX_SUPABASE_TABLE = "roblox_appeals"
ROBLOX_OAUTH_TOKENS_TABLE = "roblox_oauth_tokens"

# Bloxlink settings
BLOXLINK_API_KEY = os.getenv("BLOXLINK_API_KEY")
BLOXLINK_GUILD_ID = os.getenv("BLOXLINK_GUILD_ID", TARGET_GUILD_ID)
...
DM_GUILD_ID = os.getenv("DM_GUILD_ID", "1065973360040890418")  # optional: holding guild to enable DMs
